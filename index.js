...
function renderPokemon(pokeData){
    ...
    let pokeStats = document.createElement('ul') //ul list will hold the pokemon types

    createStats(pokeData.stats, pokeStats) // helper function to go through the types array and create li tags for each one

    pokeContainer.append(pokeName, pokeNumber, pokeTypes, pokeStats);   //appending all details to the pokeContainer div
